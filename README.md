...
RESULTS
The accuracy of the model is high - at 0.94 it is accurately predicting the dependent variable 94% of the time. The model predicts healthy loans with perfect accuracy, recall, ad f1 scores of 100%. The model is less accurate, but still overally very effective, at predicting high risk loans, with a precision score of 87%, recall of 89%, and an f1 score of 88%. 
